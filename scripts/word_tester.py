        ...
        for word_idx, word in enumerate(TARGET_WORDS):
            ...
            while action is None:
                ...
                if not ok:
                    ...
                    def _draw(frm, landmarks, connections, color, radius=2):
                    ...
                    if result.left_hand_landmarks:
                        _draw(frame, result.left_hand_landmarks, HAND_CONN, (0,255,0))
                    if result.right_hand_landmarks:
                        _draw(frame, result.right_hand_landmarks, HAND_CONN, (0,255,0))
                    if result.pose_landmarks:
                        _draw(frame, result.pose_landmarks, POSE_CONN, (255,100,0))
                    if hands_present:
